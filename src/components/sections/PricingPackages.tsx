    ...
    <section id="prezzi" ref={ref as any} className="py-24 px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {packages.map((pkg: any, idx: number) => {
          ...
          const savings = pkg.savings?.[currentLang] || pkg.savings?.['it'] || '';
          ...
          return (
            ...
            >
              ...
              <h3 className={`text-xl font-medium text-foreground ${!pkg.featured ? 'mb-4' : 'mb-4'}`}>{name}</h3>
              <div className="mb-8">
                ...
                <div className="text-sm font-medium text-emerald-400">{savings}</div>
              </div>
